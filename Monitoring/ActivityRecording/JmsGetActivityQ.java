...
//	private static final String QUEUE_NAME = "SYSTEM.ADMIN.TRACE.ACTIVITY.QUEUE"; // Queue that the application uses to put and get messages to and from
