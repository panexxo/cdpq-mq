...
/* CLOUD CONNECTION **********/	
	...
	private static final String APP_PASSWORD = "qiN1AxXxXxX_z8885xXxqixxX88887e88X_Caxx"; // Password that the application uses to connect to MQ
	...
	public static void main(String[] args) {
		...
		try {
			...
			TextMessage message = context.createTextMessage("Message sent to cloud queue! Your lucky thursday number today is " + uniqueNumber);
